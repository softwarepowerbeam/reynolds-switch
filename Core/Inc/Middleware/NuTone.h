...
/******************************************************************************/
/******************************************************************************/
//TODO: (high) check if deprecation is possible
#define NUTONE_VYV_TIMEOUT	10000


#define NUTONE_WHITE_LIGHT_ON_PULSE_TIME	500//TODO: (high) find the minimum pulse time
#define NUTONE_WHITE_LIGHT_ON_PULSES		3//!<(always use an even number) find the minimum pulse time

#define NUTONE_VYV_ON_PULSE_TIME	500//TODO: (high) find the minimum pulse time
