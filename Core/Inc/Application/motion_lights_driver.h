...
typedef enum motion_light_state
{
	...
	MOTION_LIGHT_WAIT_FOR_LIGHT,
	MOTION_LIGHT_INIT_TIMER,
	MOTION_LIGHT_WAIT_EXPIRATION,
	MOTION_LIGHT_WAIT_MOTION,
...
typedef enum motion_light_uv_state
{
	...
	MOTION_LIGHT_UV_INIT_TIMEOUT_TIMER,
	MOTION_LIGHT_UV_CHECK_TIMEOUT_TIMER,
	MOTION_LIGHT_UV_WAIT_MOTION_TIMEOUT,
	MOTION_LIGHT_UV_INIT_SAFE_TIMER,
	MOTION_LIGHT_UV_WAIT_SAFE_TIMER,
	MOTION_LIGHT_UV_WAIT_LIGHT,
